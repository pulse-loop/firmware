...
|--------------------|-------------------|-----------------------------------------------------------------------------------------------------|
| Device Information | 0x180A            | Manufacturer, model, serial number, hardware revision, firmware revision, software revision, PnP ID |
...
| Advanced configuration | C8F276D4-E0DD-4660-8070-619FF734134B | `[DEBUG ONLY]` Timing parameters, internal commands                        |
...
Advanced parameter configuration for testing and algorithm development.
...
| LED1 LED end                 | Read/Write | 9C678B37-F3AA-4B8C-AFD5-10B4694E49C7 | The end time of LED1 [µs].                     |
| LED1 LED start               | Read/Write | F02C15DF-14F1-4872-BE99-33EE64F0E0B3 | The start time of LED1 [µs].                   |
...
| LED2 LED end                 | Read/Write | B85968BA-FB52-46E8-81A5-0F837BF3D6EB | The end time of LED2 [µs].                     |
| LED2 LED start               | Read/Write | F710D5DC-2655-42D6-97AA-7A5FDF0285C8 | The start time of LED2 [µs].                   |
...
| LED3 LED end                 | Read/Write | 5B7F9859-092B-43D4-AC6B-AC9DD4742AB2 | The end time of LED3 [µs].                     |
| LED3 LED start               | Read/Write | 0B098015-110E-487E-AAE9-BEA1ED1F54A0 | The start time of LED3 [µs].                   |
