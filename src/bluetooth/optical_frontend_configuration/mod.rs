...
pub struct OpticalFrontendConfigurationServiceContainer {
    ...
    pub(crate) decimation_factor_characteristic: Arc<RwLock<Characteristic>>,
...
impl OpticalFrontendConfigurationServiceContainer {
    ...
    pub(crate) fn initialise() -> Self {
        ...
        Self {
            service,
            adc_averages_characteristic: characteristics[0].clone(),
            ambient_adc_conversion_end_characteristic: characteristics[1].clone(),
            ambient_adc_conversion_start_characteristic: characteristics[2].clone(),
            ambient_adc_reset_end_characteristic: characteristics[3].clone(),
            ambient_adc_reset_start_characteristic: characteristics[4].clone(),
            ambient_sample_end_characteristic: characteristics[5].clone(),
            ambient_sample_start_characteristic: characteristics[6].clone(),
            ambient_offset_current_characteristic: characteristics[7].clone(),
            decimation_factor_characteristic: characteristics[8].clone(),
            dynamic_power_down_end_characteristic: characteristics[9].clone(),
            dynamic_power_down_start_characteristic: characteristics[10].clone(),
            led1_adc_conversion_end_characteristic: characteristics[11].clone(),
            led1_adc_conversion_start_characteristic: characteristics[12].clone(),
            led1_adc_reset_end_characteristic: characteristics[13].clone(),
            led1_adc_reset_start_characteristic: characteristics[14].clone(),
            led1_lighting_end_characteristic: characteristics[15].clone(),
            led1_lighting_start_characteristic: characteristics[16].clone(),
            led1_current_characteristic: characteristics[17].clone(),
            led1_sample_end_characteristic: characteristics[18].clone(),
            led1_sample_start_characteristic: characteristics[19].clone(),
            led1_offset_current_characteristic: characteristics[20].clone(),
            led2_adc_conversion_end_characteristic: characteristics[21].clone(),
            led2_adc_conversion_start_characteristic: characteristics[22].clone(),
            led2_adc_reset_end_characteristic: characteristics[23].clone(),
            led2_adc_reset_start_characteristic: characteristics[24].clone(),
            led2_lighting_end_characteristic: characteristics[25].clone(),
            led2_lighting_start_characteristic: characteristics[26].clone(),
            led2_current_characteristic: characteristics[27].clone(),
            led2_sample_end_characteristic: characteristics[28].clone(),
            led2_sample_start_characteristic: characteristics[29].clone(),
            led2_offset_current_characteristic: characteristics[30].clone(),
            led3_adc_conversion_end_characteristic: characteristics[31].clone(),
            led3_adc_conversion_start_characteristic: characteristics[32].clone(),
            led3_adc_reset_end_characteristic: characteristics[33].clone(),
            led3_adc_reset_start_characteristic: characteristics[34].clone(),
            led3_lighting_end_characteristic: characteristics[35].clone(),
            led3_lighting_start_characteristic: characteristics[36].clone(),
            led3_current_characteristic: characteristics[37].clone(),
            led3_sample_end_characteristic: characteristics[38].clone(),
            led3_sample_start_characteristic: characteristics[39].clone(),
            led3_offset_current_characteristic: characteristics[40].clone(),
            tia_capacitor_1_characteristic: characteristics[41].clone(),
            tia_capacitor_2_characteristic: characteristics[42].clone(),
            tia_resistor_1_characteristic: characteristics[43].clone(),
            tia_resistor_2_characteristic: characteristics[44].clone(),
            total_window_length_characteristic: characteristics[45].clone(),
        }
    }
}
