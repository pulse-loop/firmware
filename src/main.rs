...
fn main() {
    ...
    optical::initialise(i2c, &mut interrupt_pin, &ble_api);
    ...
    let (calibration_sender, calibration_receiver) = channel::<(f32, f32)>();
                ...
                if averaged_data.0 < 10 {
                    ...
                    for (i, led) in averaged_data_iterator.enumerate() {
                        ...
                        if calibrators[i]
                            ...
                            .as_mut()
                            .unwrap()
                            .calibrate_dc(ElectricPotential::new::<microvolt>(led as f32), &calibration_sender)
                        {
